...
void DemoScene2::enter()
{
	OgreFramework::getSingletonPtr()->m_pLog->logMessage("Entering DemoScene2...");

	// Choose scene manager
	m_pSceneMgr = OgreFramework::getSingletonPtr()->m_pRoot->createSceneManager(ST_GENERIC, "DemoScene2Mgr");
...
bool DemoScene2::pause()
{
	OgreFramework::getSingletonPtr()->m_pLog->logMessage("Pausing DemoScene2...");
...
void DemoScene2::resume()
{
	OgreFramework::getSingletonPtr()->m_pLog->logMessage("Resuming DemoScene2...");
...
void DemoScene2::exit()
{
	OgreFramework::getSingletonPtr()->m_pLog->logMessage("Leaving DemoScene2...");
...
bool DemoScene2::keyPressed(const OIS::KeyEvent &keyEventRef)
{
...
bool DemoScene2::keyReleased(const OIS::KeyEvent &keyEventRef)
{
	OgreFramework::getSingletonPtr()->keyPressed(keyEventRef);
...
bool DemoScene2::mouseMoved(const OIS::MouseEvent &evt)
{
...
bool DemoScene2::mousePressed(const OIS::MouseEvent &evt, OIS::MouseButtonID id)
{
...
bool DemoScene2::mouseReleased(const OIS::MouseEvent &evt, OIS::MouseButtonID id)
{
...
void DemoScene2::onLeftPressed(const OIS::MouseEvent &evt)
{
...
void DemoScene2::update(double timeSinceLastFrame)
{
...
void DemoScene2::buildGUI()
{
	OgreFramework::getSingletonPtr()->m_pTrayMgr->showFrameStats(OgreBites::TL_BOTTOMLEFT);
	OgreFramework::getSingletonPtr()->m_pTrayMgr->showLogo(OgreBites::TL_BOTTOMRIGHT);
	OgreFramework::getSingletonPtr()->m_pTrayMgr->createLabel(OgreBites::TL_TOP, "GameLbl", "DemoScene2", 250);
...
void DemoScene2::itemSelected(OgreBites::SelectMenu* menu)
{
...
//-------------------------------------------------------------------------------------
void DemoScene2::defineTerrain(long x, long y)
{
...
//-------------------------------------------------------------------------------------
void DemoScene2::initBlendMaps(Ogre::Terrain* terrain)
{
...
//-------------------------------------------------------------------------------------
void DemoScene2::configureTerrainDefaults(Ogre::Light* light)
{
	// Configure global
...
void DemoScene2::adjustHeight(Ogre::Entity* ent)
{
