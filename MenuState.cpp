...
void MenuState::enter()
{
	...
	OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "DemoScene1Btn", "Enter DemoScene1", 250);
	OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "DemoScene2Btn", "Enter DemoScene2", 250);
	OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "DemoScene3Btn", "Enter DemoScene3", 250);
...
void MenuState::buttonHit(OgreBites::Button *button)
{
	...
	}else if(button->getName() == "DemoScene1Btn"){
		changeAppState(findByName("DemoScene1"));
	}else if(button->getName() == "DemoScene2Btn"){
		changeAppState(findByName("DemoScene2"));
	}else if(button->getName() == "DemoScene3Btn"){
		changeAppState(findByName("DemoScene3"));
	}
}
