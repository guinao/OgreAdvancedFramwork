...
// Called from within the state creation macro and sets some information of the new state, as well as pushing it on the active states stack
...
// Pause the current one and puts an new state on the top of the stack and starts it
...
//Initializes a new state and links the input and SDKTrays callback on it, as well as resetting the Ogre statistics (FPS?, triangle count, batch count, ...)
